...
func New{{ topic.StructName() }}Consumer(logger logger.Slog, config kafka.Config) (*{{ topic.StructName() }}Consumer, error) {
	logger.Info(">> New{{ topic.StructName() }}Consumer()", "{{ topic.TopicName }}", config.GroupID)
